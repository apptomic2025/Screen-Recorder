...
public class AVAssetTimeSelector: UIView, UIScrollViewDelegate {
    ...
    func constrainAssetPreview() {
        ...
        assetPreview.topAnchor.constraint(equalTo: topAnchor, constant: 2).isActive = true
        assetPreview.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -2).isActive = true
