...
public class ThumbSelectorView: AVAssetTimeSelector {
    ...
    public var thumbBorderColor: UIColor =  UIColor(named: "newBrandColor") ?? .orange{
        didSet {
    ...
    private func setupDimmingView() {
        ...
        dimmingView.topAnchor.constraint(equalTo: topAnchor, constant: 2).isActive = true
        dimmingView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -2).isActive = true
    ...
    private func setupThumbView() {
        ...
        thumbView.layer.borderColor = UIColor(named: "newBrandColor")?.cgColor
        ...
        thumbView.widthAnchor.constraint(equalToConstant: 36).isActive = true
