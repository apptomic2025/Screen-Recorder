...
@IBDesignable public class TrimmerView: AVAssetTimeSelector {
    ...
    @IBInspectable public var mainColor: UIColor = UIColor(named: "newBrandColor")! /*UIColor(named: "themeColor")!*/ {
        didSet {
            updateMainColor()
        }
    }
    ...
    @IBInspectable public var handleColor: UIColor = UIColor(named: "newBrandColor")! /* UIColor(named: "themeColor")!*/ {
        didSet {
           updateHandleColor()
        }
    }
    ...
    @IBInspectable public var positionBarColor: UIColor = UIColor.black {
        didSet {
    ...
    @IBInspectable public var maskColor: UIColor = UIColor.red {
        didSet {
    ...
    private let leftHandleKnob: UIImageView = {
        ...
        imageView.image = UIImage(named: "leftKnobIcon") // replace with your actual image name
    ...
    private let rightHandleKnob: UIImageView = {
        let imageView = UIImageView()
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIImage(named: "rightKnobIcon") // replace with your actual image name
        imageView.contentMode = .scaleAspectFit
        return imageView
    }()
    ...
    override func constrainAssetPreview() {
        assetPreview.leftAnchor.constraint(equalTo: leftAnchor, constant: 0).isActive = true
        assetPreview.rightAnchor.constraint(equalTo: rightAnchor, constant: -0).isActive = true
    ...
    private func setupHandleView() {
        ...
        NSLayoutConstraint.activate([
            leftHandleKnob.heightAnchor.constraint(equalToConstant: 24),
            leftHandleKnob.widthAnchor.constraint(equalToConstant: 24),
        ...
        NSLayoutConstraint.activate([
            rightHandleKnob.heightAnchor.constraint(equalToConstant: 24),
            rightHandleKnob.widthAnchor.constraint(equalToConstant: 24),
