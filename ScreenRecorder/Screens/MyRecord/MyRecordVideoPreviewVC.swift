...
class MyRecordVideoPreviewVC: UIViewController {
    ...
    @IBOutlet weak var lblFaceCam: UILabel!{
        didSet{
            self.lblFaceCam.font = .appFont_CircularStd(type: .medium, size: 12)
    ...
    @IBOutlet weak var lblCommentary: UILabel!{
        didSet{
            self.lblCommentary.font = .appFont_CircularStd(type: .medium, size: 12)
            self.lblCommentary.textColor = UIColor(hex: "#151517")
        }
    }
    
    @IBOutlet weak var lblVideoEdit: UILabel!{
        didSet{
            self.lblVideoEdit.font = .appFont_CircularStd(type: .medium, size: 12)
            self.lblVideoEdit.textColor = UIColor(hex: "#151517")
        }
    }
    
    @IBOutlet weak var btnFaceCam: UIButton!{
        didSet{
            self.btnFaceCam.addTarget(self, action: #selector(faceCamButtonAction), for: .touchUpInside)
        }
    }
    
    @IBOutlet weak var btnCommentary: UIButton!{
        didSet{
            self.btnCommentary.addTarget(self, action: #selector(btnCommentaryAction), for: .touchUpInside)
        }
    }
    
    @IBOutlet weak var btnVideoEdit: UIButton!{
        didSet{
            self.btnVideoEdit.addTarget(self, action: #selector(btnVideoEditAction), for: .touchUpInside)
        }
    }
...
extension MyRecordVideoPreviewVC: PlayerViewDelegate{
...
extension MyRecordVideoPreviewVC: MusicViewDelegate{
...
extension MyRecordVideoPreviewVC: UICollectionViewDataSource{
...
extension MyRecordVideoPreviewVC: UICollectionViewDelegate{
...
extension MyRecordVideoPreviewVC{
...
extension MyRecordVideoPreviewVC: UICollectionViewDelegateFlowLayout{
...
extension MyRecordVideoPreviewVC: FilterViewDelegate{
...
extension MyRecordVideoPreviewVC: CropViewDelegate{
...
extension MyRecordVideoPreviewVC: TrimmerViewDelegate {
    ...
    func trimmerView(_ trimmer: TrimmerView,
        ...
        // Make the indicator visible during drag, if it's currently hidden.
        ...
        // Update the indicator's position and time label.
        ...
        // You can call this to update the layout if needed.
        // self.view.layoutIfNeeded()
    }
    ...
    func trimmerView(_ trimmer: TrimmerView,
        ...
        // Hide the indicator again when dragging ends.
        UIView.animate(withDuration: 0.15) {
...
extension MyRecordVideoPreviewVC: ExportDelegate{
...
extension MyRecordVideoPreviewVC: CropPickerViewDelegate {
...
extension MyRecordVideoPreviewVC: VideoDelegate {
