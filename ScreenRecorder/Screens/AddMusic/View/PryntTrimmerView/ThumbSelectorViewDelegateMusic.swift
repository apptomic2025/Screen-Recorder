...
public protocol ThumbSelectorViewDelegateMusic: AnyObject {
...
public class ThumbSelectorViewMusic: AVAssetTimeSelectorMusic {
    ...
    public weak var delegate: ThumbSelectorViewDelegateMusic?
    ...
    private func setupThumbView() {
        ...
        let panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(ThumbSelectorViewMusic.handlePanGesture(_:)))
