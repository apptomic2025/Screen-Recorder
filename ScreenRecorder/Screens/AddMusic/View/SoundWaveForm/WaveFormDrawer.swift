...
extension WaveColor {
    ...
    func highlight(withLevel: CGFloat) -> WaveColor? {
        var hue: CGFloat = 0.0, saturation: CGFloat = 0.0, brightness: CGFloat = 1, alpha: CGFloat = 0.0
...
public struct WaveformConfiguration {
    ...
    public var centralLineColor: UIColor = UIColor.white // Its color

    public init(size: CGSize,
                color: UIColor = UIColor.red,
                backgroundColor: UIColor = UIColor(red: 47/255, green: 47/255, blue: 47/255, alpha: 1),
...
open class WaveFormDrawer {
    ...
    private static func _drawGraph(from sampling:(samples: [Float], sampleMax: Float),
        ...
        case .gradient:
            ...
            context.clip()
            let highlightedColor = configuration.color.highlight(withLevel: 1) ?? UIColor.white
